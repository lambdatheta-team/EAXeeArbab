	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="architect_register" method='POST'>
					...
					<div class="wrap-input100 validate-input" data-validate="Company Name">
						<input id="company_name" class="input100" type="text" name='company_name' placeholder="Company Name" disabled	>
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="user-types">
	                    <select class="input100" name='user_type'>
        					<option value="" selected disabled>Select User Type</option>
        					<option value="EAXee">EAXee</option>
...
<!-- 					</div> -->
	...
	window.onload = (event) => {
		...
		$.ajax({
		    url: "getCompanyNameForArchitectRegistration", // url: "/findTables?dbName="+db_name,
		  	method: 'get',
		    //type: "GET",
		    data: {},
